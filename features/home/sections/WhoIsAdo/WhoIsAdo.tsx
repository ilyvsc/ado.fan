        ...
        <div className="intro-text-col col-span-4 space-y-6">
          ...
          <div className="intro-text max-w-xl space-y-4">
            <p className="text-justify text-base leading-8 text-muted-foreground md:text-lg">
              ...
              Japan&apos;s utaite scene — a community of singers known for giving
              their own voice to VOCALOID songs — and built recognition through vocal
              performance alone.
            </p>
            <p className="text-justify text-base leading-8 text-muted-foreground md:text-lg">
              What set her apart was never polished presentation. It was the raw
              emotional weight of her voice — a delivery that could shift from
              whispered vulnerability to explosive rage within a single phrase. Before
              the world knew her name, the underground already understood what she was
              becoming.
            </p>
          </div>
        </div>
