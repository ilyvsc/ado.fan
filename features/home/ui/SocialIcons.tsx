    ...
    >
      {links.map((link) => (
        <Link
          ...
          data-social-card
        >
          <div className="relative flex items-start gap-3 rounded-md border border-foreground/5 bg-foreground/5 p-4 transition-all duration-300 hover:-translate-y-0.5 hover:border-ado-primary/20 hover:bg-foreground/10">
