        ...
        <Card className="border-0 bg-gradient-to-br from-card/95 to-card/80 shadow-2xl backdrop-blur-sm">
          <CardHeader className="px-6 pt-8 pb-0 md:px-8 md:pt-10">
            <div className="flex flex-col items-center space-y-4">
              ...
              <CardTitle className="text-center text-3xl font-bold text-ado-red uppercase md:text-6xl">
          ...
          <CardContent className="space-y-2 px-6 pb-8 md:space-y-4 md:px-8 md:pb-10">
            <div className="transform rounded-lg border border-ado-red/50 bg-ado-red/5 p-4 shadow-lg transition-transform hover:scale-[1.02] md:p-6">
